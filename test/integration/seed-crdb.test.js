...
test('v1 seed preserves sealed upstream isolation', { skip: !enabled }, async () => {
  ...
  try {
    ...
    const calls = await pool.query(`SELECT count(*)::INT AS count FROM hearth_provider_calls WHERE entry_id = 'demo_039'`);
